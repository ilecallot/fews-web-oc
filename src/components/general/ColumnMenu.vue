<template>
  <v-toolbar density="compact" data-cy="column-menu--toolbar">
  ...
  <v-window v-model="currentLevel" data-cy="column-menu--window">
    <v-window-item
      v-for="(item, i) in stack"
      v-bind:key="i"
      data-cy="column-menu--window-item"
    >
